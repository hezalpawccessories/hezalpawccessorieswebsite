            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <h1 className="text-4xl md:text-6xl font-bold text-text-dark mb-6">
                  Your Pet Deserves Only the{' '}
                  <span className="text-primary-pink">BEST</span>
                </h1>
                <p className="text-xl text-text-light mb-8 leading-relaxed">
                  Discover premium pet accessories that combine style, comfort, and quality. 
                  From adorable collars to cozy beds, we have everything your furry friend needs.
                </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-text-light">
                Discover our most popular pet accessories
              </p>
            </motion.div>
                ...
                >
                  <div className="flex items-center mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star key={i} className="w-5 h-5 text-soft-yellow" fill="currentColor" />
                    ))}
                  </div>
