            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-primary-blue"
                />
              </div>
                  ...
                  <div className="mb-4">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                      {selectedProduct.details.map((detail, index) => (
                        <li key={index} className="text-text-light text-sm">
                          {detail}
                        </li>
                      ))}
                    </ul>
