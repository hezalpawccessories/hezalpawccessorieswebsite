                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16'>
                     {contactInfo.map((info, index) => (
                        ...
                        >
                           ...
                           <h3 className='text-lg font-nunito font-bold text-text-dark mb-2'>{info.title}</h3>
                           <p className='font-dm-sans text-primary-pink font-semibold mb-1'>{info.details}</p>
                           <p className='font-dm-sans text-text-body text-sm'>{info.description}</p>
                        </motion.div>
                     ))}
                  </div>
                  ...
                  <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-start'>
                     ...
                     >
                        ...
                        >
                           <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                              <div>
                                 <label className='block text-sm font-medium text-text-dark mb-2'>Your Name *</label>
                                 <input
                                    type='text'
                                    required
                                    value={formData.name}
                     ...
                     >
                        ...
                        <div className='bg-soft-yellow/20 p-6 rounded-2xl'>
                           <h3 className='text-lg font-bold text-text-dark mb-2'>Quick Response Promise</h3>
                           <p className='text-text-light'>
                              We typically respond to all inquiries within 24 hours. For urgent matters, please call us
            ...
            <section className='py-20 bg-white'>
               <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                  <motion.div
                     ...
                     className='text-center mb-16'
                  >
                     <h2 className='text-3xl md:text-4xl font-bold text-text-dark mb-4'>Frequently Asked Questions</h2>
                     <p className='text-xl text-text-light'>Quick answers to common questions</p>
                  </motion.div>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                     {[
                        ...
                        >
                           <h3 className='text-lg font-bold text-text-dark mb-3'>{faq.question}</h3>
